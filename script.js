...
function toggleImage() {
  ...
  if (flag == 0) {
    toggleImageId.src = "assets/Images/moon_or.png";
    ...
    toggleImageId.src = "assets/Images/light.png";
    for (let i = 0; i < butt.length; i++) {
...
function Click(User_Choice) {
  ...
  if (User_Choice == "Rock") {
    ...
    image.src = "assets/Images/Scissor.png";
  }
  if (Com == "Rock") {
    image1.src = "assets/Images/Rock-ch.png";
  } else if (Com == "Paper") {
    image1.src = "assets/Images/Paper-ch.png";
    image1.style.width = "35%";
  } else if (Com == "Scissor") {
    image1.src = "assets/Images/Scissor-org.png";
  }
